...
My long-term goal is to build a **Virtual Embryo**—a computational system capable of simulating developmental trajectories with biological fidelity to illuminate mechanisms of congenital disease and enable preventive interventions before birth.
...
**Stanford University**  
M.S. in Management Science & Engineering, 2024-2025

**Duke University & Duke Kunshan University**  
B.S. in Applied Mathematics, 2020-2024  
*Scholarship Award (Top 5%)*
...
I am currently working on several projects in the [Qiu Lab](https://www.devo-evo.com/) at Stanford University:

**Virtual Embryo Framework** (Lead Researcher)  
Designing a multi-scale, cross-modal framework for predictive embryo modeling using hierarchical graph neural networks, flow matching, and transformers. Manuscript in preparation for Nature Comment.

**Neural Field for 3D Embryo Reconstruction** (Core Contributor)  
Developing a differentiable framework for reconstructing 3D embryonic structures from 2D spatial transcriptomic slices with enhanced Transformer-based positional encodings. To be submitted to Nature Biotechnology.

**Dynamo: RNA Velocity & Vector Field Analysis** (Co-author)  
Predictive modeling of single-cell transcriptomic dynamics, including differential geometry analyses and in silico perturbation predictions. Manuscript under review at Nature Protocols.
...
**Virtual Cell/Embryo and Single Cell/Spatial Genomics Dataset Modeling**  
*Qiu Lab, Stanford University | Mar 2024 - Present*  
...
**Deep Learning for Consumption and Production Management in Circular Economy**  
...
*HPC-AI Lab, National University of Singapore | Apr 2023 - Sep 2023*  
...
**Neural Field: Generative Framework for 3D Embryo Reconstruction**  
*Sep 2025 - Present*  
...
**Dynamo-Release: Dynamic Modeling for Single-Cell Trajectories** ([472★ GitHub](https://github.com/aristoteleo/dynamo-release))  
*Aug 2025 - Present*  
...
**SENTINEL: AI-Generated Text Detection** (CS 224N Project)  
*Apr 2024 - Jun 2024*  
...
*[Sahara AI](https://saharalabs.ai) | San Francisco, CA | Jun 2024 - Sep 2024*  
...
*[Ping An Technology](https://tech.pingan.com) | Beijing, China | Aug 2022 - Aug 2023*  
...
*[Sequoia Capital China](https://www.sequoiacap.com) | Beijing, China | Oct 2022 - Apr 2023*  
